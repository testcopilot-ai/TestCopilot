...
# CONFIG
# =========================================================
CHATGPT_API_KEY = "INSERT_YOUR_API"
CHATGPT_BASE_URL = "https://api.openai.com/v1"
CHATGPT_MODEL = "gpt-4-turbo"
...
# ChatGPT Call
# =========================================================
def chat_with_chatgpt(user_input: str, model: str = CHATGPT_MODEL) -> str:
    if not CHATGPT_API_KEY or "INSERT_YOUR_API" in CHATGPT_API_KEY:
        return "VERDICT: FAIL\nREASONS:\n- Missing API key."

    url = f"{CHATGPT_BASE_URL.rstrip('/')}/chat/completions"
    headers = {
...
""".strip()
    ...
    return chat_with_chatgpt(prompt)
